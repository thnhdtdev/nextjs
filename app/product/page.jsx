        ...
        <main className="min-h-screen bg-gray-50 p-8">
            ...
            <div className="grid grid-cols-6 gap-6">
                {products.map((p) => (
                    ...
                    >
                        <Link href={`/product/${p.id}`} className="flex-1 flex flex-col items-start">
                            <img
                                src={p.image}
                                alt={p.title}
                            ...
                            <div className="flex items-center mt-2">
                                ...
                                <span key={i}>
                                  {i < Math.floor(p.rating.rate) ? <Star size={16} fill="#ffd700" color="#ffd700" /> : <Star color="#ffd700" size={16} />}
                                </span>
                                ))}
                                <span className="ml-2 text-sm text-gray-500">({p.rating.count} review)</span>
                            </div>
                        </Link>
